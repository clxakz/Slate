    ...
    return (
      ...
      >
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="absolute top-1 z-10 w-full max-h-[150px] custom-scrollbar rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in"
              onMouseLeave={() => {
